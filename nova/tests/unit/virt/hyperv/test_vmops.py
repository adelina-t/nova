...
class VMOpsTestCase(test_base.HyperVBaseTestCase):
    ...
    def _test_spawn(self, mock_validate_and_update_bdi, mock_delete_disk_files,
    ...
    def _test_create_instance(self, mock_attach_ephemerals,
    ...
    def test_attach_root_device_volume(self, mock_attach_volume):
        mock_instance = fake_instance.fake_instance_obj(self.context)
        root_device_info = {'type': os_win_const.VOLUME,
    ...
    def test_get_image_vm_generation_default(self):
        ...
        response = self._vmops.get_image_vm_generation(
            mock.sentinel.INSTANCE_UUID, image_meta)
    ...
    def test_check_vm_image_type_exception(self):
        ...
        self.assertRaises(exception.InstanceUnacceptable,
            self._vmops.check_vm_image_type, mock.sentinel.INSTANCE_UUID,

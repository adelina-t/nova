...
class VMOps(object):
    ...
    def reboot(self, instance, network_info, reboot_type):
        ...
        self._serialconsoleops.stop_console_handler(
            instance['name'])
    ...
    def _set_vm_state(self, instance, req_state):
        ...
        try:
            if req_state not in (constants.HYPERV_VM_STATE_ENABLED,
                                 constants.HYPERV_VM_STATE_DISABLED,
                                 constants.HYPERV_VM_STATE_REBOOT):
                self._serialconsoleops.stop_console_handler(
                    instance_name)
            ...
            if req_state in (constants.HYPERV_VM_STATE_ENABLED,
                             constants.HYPERV_VM_STATE_REBOOT):
                self._serialconsoleops.start_console_handler(instance_name)
